...
namespace PMP.UnityLib {
    ...
    public static class TransformExt {
        ...
        /// child を自身の子に追加します。
        /// </summary>
        public static void AddChild(this Transform self, GameObject child) {
        ...
        /// 自身を破棄します。
        /// </summary>
        public static void Destroy(this Transform self, float time) {
        ...
        /// </summary>
        public static void DontDestroyOnLoad(this Transform self) {
